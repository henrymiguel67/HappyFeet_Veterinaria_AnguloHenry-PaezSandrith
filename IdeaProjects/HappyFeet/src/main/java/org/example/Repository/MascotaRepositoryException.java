...
public class MascotaDAO implements IMascotaDAO {
    ...
    public void agregarMascota(Mascota mascota) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new MascotaRepositoryException("Error al agregar mascota: " + e.getMessage(), e);
        }
    }
    ...
    public List<Mascota> listarTodas() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new MascotaRepositoryException("Error al listar mascotas: " + e.getMessage(), e);
        }
    ...
    public Optional<Mascota> buscarPorId(Integer id) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new MascotaRepositoryException("Error al buscar mascota por ID: " + e.getMessage(), e);
        }
    ...
    public List<Mascota> buscarPorDuenoId(Integer duenoId) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new MascotaRepositoryException("Error al buscar mascotas por dueño: " + e.getMessage(), e);
        }
    ...
    public List<Mascota> buscarPorNombre(String nombre) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new MascotaRepositoryException("Error al buscar mascotas por nombre: " + e.getMessage(), e);
        }
    ...
    public void actualizarMascota(Mascota mascota) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new MascotaRepositoryException("Error al actualizar mascota: " + e.getMessage(), e);
        }
    }
    ...
    public void eliminarMascota(Integer id) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new MascotaRepositoryException("Error al eliminar mascota: " + e.getMessage(), e);
        }
    }
    ...
    public boolean existeMascota(String nombre, Integer duenoId) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new MascotaRepositoryException("Error al verificar mascota: " + e.getMessage(), e);
        }
