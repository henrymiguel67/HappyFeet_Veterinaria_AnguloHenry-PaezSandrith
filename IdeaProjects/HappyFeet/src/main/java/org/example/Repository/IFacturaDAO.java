...
public class FacturaDAO implements IFacturaDAO {
    ...
    public void generarFactura(Factura factura) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setTimestamp(2, new Timestamp(factura.getFechaEmision().getTime()));
    ...
    @Override
    public List<Factura> buscarPorRangoFechas(java.util.Date fechaInicio, java.util.Date fechaFin) {
        List<Factura> facturas = new ArrayList<>();
    ...
    public boolean existeFactura(Integer id) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Error al verificar factura: " + e.getMessage(), e);
        }
    ...
    public Integer contarFacturasPorPeriodo(java.util.Date fechaInicio, java.util.Date fechaFin) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Error al contar facturas: " + e.getMessage(), e);
        }
        
        return 0;
    }

    // Método auxiliar para mapear ResultSet a objeto Factura
